...
#             source=dict(
#                 train=[os.path.join(self.__tfrecord_source, 'train_%i.tfrecord' % i) for i in range(10)],
#                 valid=[os.path.join(self.__tfrecord_source, 'valid_%i.tfrecord' % i) for i in range(10)]
#             ),
#             target=dict(
#                 # train=[os.path.join(self.__tfrecord_source, 'train_%i.tfrecord' % i) for i in range(10)],
#                 # valid=[os.path.join(self.__tfrecord_source, 'valid_%i.tfrecord' % i) for i in range(10)]
...
#                 # self.__iterator_ini_src is list of initializer corresponding to each label
