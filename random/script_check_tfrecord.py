...
def get_options(parser):
    ...
    parser.add_argument('-n', '--num', help='number to show', default=10, type=int, **share_param)
...
class TestTFRecord:
    ...
    def __init__(self,
        ...
        self.__read_tf, self.__meta = deep_da.TFRecorder().read_tf('%s/%s' % (CONFIG["TFRECORD_DIR"], args.data),
                                                                   is_image=True)
        self.__build_graph()
